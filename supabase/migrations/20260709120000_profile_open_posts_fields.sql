-- ============================================================
-- Profile redesign — carry the fields the feed SubCard needs
-- into get_profile.active_posts (play_type, duration, notes,
-- status) so the profile page can render "Open posts" as the
-- same feed-style cards. Everything else is unchanged.
-- ============================================================
