        ...
        <div className="min-h-dvh overflow-x-clip bg-primary">
            ...
            <div className="mx-auto flex min-h-dvh w-full max-w-md flex-col md:max-w-2xl lg:max-w-6xl">
                ...
                <section className="mt-10 px-5 md:mt-14 md:px-8 lg:mt-16">
                    {/* text-xl on phones, display-xs from md up. Deliberately smaller
                        than the CTA heading below, which stays on the full display
                        scale. md and lg are the same size, so one breakpoint covers
                        both — lg inherits it. */}
                    <h2 className="text-xl font-semibold text-balance text-primary md:text-display-xs">
                        How CourtPlay works:
                    </h2>
