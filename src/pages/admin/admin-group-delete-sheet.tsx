...
export function AdminGroupDeleteSheet({ group, onClose, onDeleted }: AdminGroupDeleteSheetProps) {
    ...
    return (
        ...
        >
            ...
            <motion.div
                className="relative flex max-h-[85vh] w-full max-w-md flex-col gap-4 sheet-fill rounded-t-2xl bg-secondary px-5 pt-5 pb-[calc(2rem_+_var(--safe-bottom))] shadow-xl sm:rounded-2xl"
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
